...
describe('LoginComponent', () => {
  ...
  beforeEach(() => {
    ...
    errorAlertPatternUsername = fixture.nativeElement.querySelector(
      '#error-pattern-username'
    );
  ...
  it('should display username pattern validation error', fakeAsync(() => {
    fixture.whenStable().then(() => {
      ...
      expect(
        fixture.nativeElement
          .querySelector('#error-pattern-username')
          .textContent.trim()
      ).toBe('Username should be in alphanumeric only');
    });
  }));
  ...
  it('should not redirect to other pages on occurence of error', fakeAsync(() => {
    ...
    spyOn(dataService, 'authenticateUser').and.returnValue(
      throwError(expectedErrorResponse)
    );
    fixture = TestBed.createComponent(LoginComponent);
    component = fixture.componentInstance;
    fixture.detectChanges();
  ...
  it('should navigate to register-new-user page when clicked on "sign up" button', fakeAsync(() => {
    const eleGuestUserButton =
      fixture.nativeElement.querySelector('#signupBtn');
